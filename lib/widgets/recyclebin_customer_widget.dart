...
import 'package:udhar/screen/recycle_customer_detail_screen.dart';

import 'package:udhar/utils/app_constant.dart';

class RecyclebinCustomerWidget extends StatelessWidget {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                GestureDetector(
                  onTap: () async {
                    customerController.restorerecyclebin(
                      customername,
                      customeraddress,
                      customerphone,
                      customeramount,
                    ...
                    await customerController.fetchRecycleCustomer();
                  },
                ...
                Row(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        await customerController.deleterecyclebin(customername);
